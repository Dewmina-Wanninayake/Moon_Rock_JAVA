...
<body>
		...
		<div class="form-box login">
			...
			<form method="POST" action="UpdateStaff">
				...
				<div class="input-box">
					...
					<input type="text" name="uid" value="${param.uid}" readonly>
				...
				<div class="input-box">
					...
					<input type="text" id="address" name="address" value="${param.address}" placeholder="Address">
					
				</div>
				<div class="input-box">

					<input type="text" id="type" name="type" value="${param.type.toLowerCase()}" placeholder="Type">
    ...
    <script>
        ...
        function handleClose() {
            const form = document.getElementById("customerForm");//close button
