                  ...
                  <nav class="navigation navbar navbar-expand-md navbar-dark justify-content-center">
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04" style="margin-left: 30%;">
                        <ul class="navbar-nav mx-auto">
                           ...
                           <li class="nav-item"><a class="nav-link active" href="room.jsp">Our&nbsp;rooms</a></li>
   ...
   <div class="our_room">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage">
                  <p class="margin_0">These are the currently available rooms</p>
               </div>
            </div>
         </div>
		...
		<div class="col-md-4 col-sm-6">
		    <div class="room" data-room-id="<%= rid %>" style="cursor: pointer;">
		        <div class="room_img">
