...
<body class="main-layout">
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="titlepage">
               <p class="margin_0">Explore Our Premium Services</p>
            </div>
         </div>
      </div>
      ...
      <%
	   ...
	   %>
		...
		<div class="col-md-4 col-sm-6">
		   <a href="serviceDetails.jsp?serviceId=<%= serviceId %>" style="text-decoration: none; color: inherit;">
		      <div id="serv_hover" class="room">
		         <div class="room_img">
		            <figure><img src="<%= image %>" alt="<%= serviceName %>" /></figure>
		         </div>
		         <div class="bed_room">
		            <h3><%= serviceName %></h3>
		            <p><%= description %></p>
